  ...
  _createClass(Toggle, [{
    ...
    value: function render() {
      var _props = this.props,
          ...
          passthroughProps = _objectWithoutProperties(_props, ['checkedIcon', 'uncheckedIcon']);

      var toggleClasses = _defineProperty({
        'toggle-icon': true,
      ...
      return _react2.default.createElement(
        'div',
        null,
        _react2.default.createElement('input', _extends({}, passthroughProps, { style: { display: 'none' } })),
